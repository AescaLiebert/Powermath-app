...
- **Primary platform first:** Every interaction must be described for the project's primary platform input model before secondary platforms. Check `1_Inputs_Templates/GDD.md` @tag:platform-input for which platform is primary.
...
- **Save your output:** Write design specs to `Docs/3_Outputs/Specs/{feature-name}-design-spec.md`.
