...
namespace PowerMath.Gameplay.Combat.Unity
{
    ...
    public sealed class FloatingRewardTextView : MonoBehaviour
    {
        [Header("Components")]
        [Tooltip("Primary foreground TMP component.")]
        ...
        [Tooltip("Optional image icon displayed alongside reward text (e.g. currency coin icon).")]
